      ...
      <UModal v-model="open">
        <div class="p-4">
          ...
          <p class="mt-2 text-base text-gray-500">
            由于服务升级，我们将域名从原域名迁移至 <NuxtLink class="link hover:text-green-500" to="https://szxd.swu.lol/">https://szxd.swu.lol/</NuxtLink> 原有服务不受影响，原域名将会在一段时间后停止服务，请您尽快更换域名来访问我们的服务!
          </p>
          <div class="mt-4 flex justify-end">
