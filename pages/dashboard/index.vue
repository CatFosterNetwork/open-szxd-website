      ...
      <UModal v-model="isOpened">
        <div class="p-4">
          ...
          <p class="mt-2 text-sm text-gray-500">
            ...
            在节假日期间，若您不在学校，您可以通过网页VPN或者客户端VPN进入 <NuxtLink class="link hover:text-green-500" to="http://10-132-98-229.sangfor.vpn.swu.edu.cn:8118/">http://10-132-98-229.sangfor.vpn.swu.edu.cn:8118/</NuxtLink>
            来访问我们的服务!
          </p>
